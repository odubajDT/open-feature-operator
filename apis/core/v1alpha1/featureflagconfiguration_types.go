...
func (ff *FeatureFlagConfiguration) GetFfReference() metav1.OwnerReference {
...
func (ff *FeatureFlagConfiguration) GenerateFfConfigMap(name string, namespace string, references []metav1.OwnerReference) corev1.ConfigMap {
